    ...
    <div id="page-contents">
      <div class="container ">
        ...
        <div class="row">
		    ...
		    <br>
		    <button class="btn btn-primary" type="button" onclick="location.href='${pageContext.request.contextPath}/customerservice/csQList.do'">뒤로가기</button>
		   
			<button class="btn btn-primary" type="button" onclick="location.href='${pageContext.request.contextPath}/customerservice/csQuestionUpdateView.do?qNo=${question.qNo}'">수정 하기</button>
