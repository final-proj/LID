                    ...
                    <div class="friend-card">
                      ...
                      <div class="card-info">
                        ...
                        <div class="friend-info">
                          ...
                          <h5><a href="${path}/friendpage/goFriendAbout.do" class="profile-link">Sophia Lee</a></h5>
                          <p>나와의 거리 17km</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6 col-sm-6">
                    <div class="friend-card">
                      ...
                      <div class="card-info">
                        ...
                        <div class="friend-info">
                          <a href="#" class="pull-right text-green">My Friend</a>
                          <h5><a href="${path}/friendpage/goFriendAbout.do" class="profile-link">Alexis Clark</a></h5>
                          <p>나와의 거리 3km</p>
                        </div>
                      </div>
                    </div>
