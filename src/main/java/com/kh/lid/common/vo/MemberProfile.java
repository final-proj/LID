...
public class MemberProfile implements Serializable {
   ...
   private float mpLatitude; // 위도
   private float mpLongitude; // 경도
   ...
   public MemberProfile(int mpNo, int mpMno, String mpNickname, String mpGender, int mpAge, String mpIntroduce,
         String mpAddress, String[] mpHobby, String mpImg, float mpLatitude, float mpLongitude, int imgCount,
         List<MemberProfileImg> imgList) {
      super();
      this.mpNo = mpNo;
      this.mpMno = mpMno;
      this.mpNickname = mpNickname;
   ...
   public String toString() {
      return "MemberProfile [mpNo=" + mpNo + ", mpMno=" + mpMno + ", mpNickname=" + mpNickname + ", mpGender="
            ...
            + ", mpHobby=" + Arrays.toString(mpHobby) + ", mpImg=" + mpImg + ", mpLatitude=" + mpLatitude
            + ", mpLongitude=" + mpLongitude + ", imgCount=" + imgCount + ", imgList=" + imgList + "]";
   }

   public float getMpLatitude() {
      return mpLatitude;
   }

   public void setMpLatitude(float mpLatitude) {
      this.mpLatitude = mpLatitude;
   }

   public float getMpLongitude() {
      return mpLongitude;
   }

   public void setMpLongitude(float mpLongitude) {
      this.mpLongitude = mpLongitude;
   }
